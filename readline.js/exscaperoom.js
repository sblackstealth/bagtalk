...
var firstRoomObjects = [
    ...
    new RoomObject("closet", "", ["flashlight"], [], ["open"]),
    new RoomObject("computer", "empty shell", [], [], ["examine"]),
]

var kitchenObjects = [
    new RoomObject("Door", "You need a key", [], ["lockpick"], ["jimmy"]),
    new RoomObject("fridge", "nothing", [], [], ["search"]),
    new RoomObject("mircrowave", "plate", ["lockpick"], [], ["open"]),
]
...
// Create a new Player
var player = new Player(player.getCurrentRoom(rooms[0]))
/*
Some clarifications: 
